...
<div class="site-info">
	<div class="container">
		<?php echo '&copy; '.date_i18n(__('Y','corporatebits')); ?> <?php bloginfo( 'name' ); ?> <?php echo esc_html('| Theme: ', 'corporatebits'); ?> <a href="<?php echo esc_url( __( 'http://develobots.com/', 'corporatebits' ) ); ?>" ><?php echo esc_html('CorporateBits ', 'corporatebits'); ?> </a>
	</div>
</div>
